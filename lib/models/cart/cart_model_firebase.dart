...
class CartModelFirebase
  ...
  static final CartModelFirebase _instance = CartModelFirebase._internal();

  factory CartModelFirebase() => _instance;

  CartModelFirebase._internal();
  ...
  double getProductPrice(id) {
    ...
    final isVariantion = productVariation != null &&
        (productVariation.hasSalePrice || productVariation.hasPrice);

    if (isVariantion) {
      return productVariation.valuePrice * productsInCart[id]!;
    } else {
